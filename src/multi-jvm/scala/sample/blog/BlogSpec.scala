  ...
  "Sharded blog app" must {
    ...
    "create, edit, and retrieve blog post" in within(15.seconds) {
      ...
      runOn(node1) {
        ...
        postRegion ! Post.AddPost(postId,
          Post.PostContent(List("Patrik"), "Sharding algorithms", "Splitting shards..."))
      ...
      runOn(node2) {
        ...
        awaitAssert {
          within(1.second) {
            ...
            expectMsg(Post.PostContent(List("Patrik"), "Sharding algorithms", "Splitting shards across multiple..."))
          }
        }
      }
    ...
    "publish and list blog post" in within(15.seconds) {
      ...
      runOn(node1) {
        ...
        postRegion ! Post.AddPost(postId,
          Post.PostContent(List("Patrik"), "Hash functions", "A hash function should be deterministic..."))
